...
We released [MUI X](https://brianstoker.com/x/), a collection of advanced components; [MUI Design kits](https://brianstoker.com/design-kits/), the MUI components available for Figma, Sketch, etc.; and also host [Templates](https://brianstoker.com/templates/), a set of pre-built UI kits.
We've seen rapid growth with all of them (2x per year) and we have more to come.
We are building [a low-code platform](https://brianstoker.com/toolpad/) for developers to significantly increase the speed and lower the barrier for creating simple CRUD/dashboard UIs with MUI's libraries.
