...
Learn more about MUI's products in this plan post: [An introduction to the MUI ecosystem](https://mui.com/plan/bs-product-comparison/). (This is also the kind of content you might create!)
...
Learn more about what we value as an organization: [Evolving MUI's core values and behaviors](https://mui.com/plan/2023-mui-values/).
...
- Revamp the company plan infrastructure to empower less technical teammates to contribute (for example HR)
