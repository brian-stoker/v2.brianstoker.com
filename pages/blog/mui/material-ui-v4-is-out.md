...
<p class="blog-description">https://brianstoker.com/</p>
...
This release happens within our [fixed frequency](https://brianstoker.com/versions/#release-frequency) release strategy. We try to release a major at least every 12 months and at most every 6 months. The migration from v0 to v1 was painful, it almost felt like using two different UI libraries. We've done our best to minimize the time needed to migrate from v3 to v4. To help ease the transition, you can follow this [migration guide](/material-ui/migration/migration-v3/) 📚. It shouldn't take more than a few hours.
...
<p class="blog-description"><a href="https://v4.brianstoker.com/components/text-fields/#customized-inputs">live demo</a></p>

![Demo2](/static/blog/material-ui-v4-is-out/demo2.png)

<p class="blog-description"><a href="https://v4.brianstoker.com/components/tabs/#customized-tabs">live demo</a></p>
...
We are working on [a Premium theme store](https://brianstoker.com/store/).
