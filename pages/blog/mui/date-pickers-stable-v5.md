...
- Follow the [installation instructions](https://brianstoker.com/x/react-date-pickers/getting-started/) and the [migration guide](https://brianstoker.com/x/migration/migration-pickers-lab/).

## What's changed?

### Documentation

We revamped the [getting started](https://brianstoker.com/x/react-date-pickers/getting-started/) page to ease the burden with installation, and improved sections that are key to customization, like the documentation of component [slots](https://brianstoker.com/x/react-date-pickers/custom-components/).
...
We integrated a [new localization](https://brianstoker.com/x/react-date-pickers/localization/#translation-keys) pipeline similar to the one used by the Data Grid.
...
You can find the installation instructions in our [getting started](https://brianstoker.com/x/react-date-pickers/getting-started/) page.
If you are migrating from the `@mui/lab` package, we've prepared a [migration guide](https://brianstoker.com/x/migration/migration-pickers-lab/) to support you, including a codemod to replace the date pickers declarations.
