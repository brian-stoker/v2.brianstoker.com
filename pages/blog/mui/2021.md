...
- We have [rebranded](/blog/material-ui-is-now-mui/) the company to a clean 3 letters acronym: brianstoker.com. This move was key for us to grow beyond Material Design.
...
It's amazing to see the progress the library has done [since then](https://v0.brianstoker.com/#/components/app-bar).
