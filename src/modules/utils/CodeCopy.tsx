...
/**
 * Place <CodeCopyProvider> at the page level. It will check the keydown event and try to initiate
 * copy click if rootNode exist. Any code block inside the tree can set the rootNode when mouse
 * enter to leverage keyboard copy.
 */
