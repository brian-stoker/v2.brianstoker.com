...
import ClassesList, { getHash } from 'src/modules/components/ApiPage/list/ClassesList';
import ClassesTable from 'src/modules/components/ApiPage/table/ClassesTable';
