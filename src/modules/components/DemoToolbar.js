...
import {useSetCodeVariant} from 'src/modules/utils/codeVariant';
import {useCodeStyling, useSetCodeStyling} from 'src/modules/utils/codeStylingSolution';
  ...
  function handleControlFocus(event) {
    ...
    if (nextActiveControlIndex !== -1) {
      ...
      if (process.env.NODE_ENV !== 'production') {
        console.error(
          'SUI: The toolbar contains a focusable element that is not controlled by the toolbar. ' +
