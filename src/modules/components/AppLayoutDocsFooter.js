...
/**
 * @typedef {import('src/pages').MuiPage} MuiPage
 * @typedef {import('src/pages').OrderedMuiPage} OrderedMuiPage
 */
      ...
      <Stack component="footer" direction="column" spacing={2.5} sx={{ my: 6 }}>
        ...
        >
          <Stack direction="row" alignItems="center" spacing={1.2} useFlexGap sx={{ flexGrow: 1 }}>
            <Link href="https://stoked-ui.github.io/" aria-label="Go to homepage">
