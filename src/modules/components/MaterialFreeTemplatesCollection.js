...
function layouts(t) {
  return [
    ...
    },
    {
      ...
      source: `${sourcePrefix}/docs/data/stoked-ui/getting-started/templates/landing-page`,
    },
    {
      ...
      source: `${sourcePrefix}/docs/data/stoked-ui/getting-started/templates/checkout`,
    },
    {
      title: t('signInTitle'),
      ...
      source: `${sourcePrefix}/docs/data/stoked-ui/getting-started/templates/sign-in`,
    },
    {
      ...
      source: `${sourcePrefix}/docs/data/stoked-ui/getting-started/templates/sign-in-side`,
    },
    {
      title: t('signUpTitle'),
      ...
      source: `${sourcePrefix}/docs/data/stoked-ui/getting-started/templates/sign-up`,
    },
    {
      title: t('blogTitle'),
    ...
    },
    {
      ...
      source: `${sourcePrefix}/docs/data/stoked-ui/getting-started/templates/sticky-footer`,
    },
  ];
}
