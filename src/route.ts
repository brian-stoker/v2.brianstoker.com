...
const ROUTES: Routes = {
  ...
  // Stoked UI doc pages
  materialDocs: 'https://sui.stokd.cloud/material-ui/getting-started/',
  ...
  // System pages
  systemDocs: 'https://sui.stokd.cloud/system/getting-started/',
  // X general pages
  xIntro: 'https://sui.stokd.cloud/x/introduction/',
  ...
  store: 'https://sui.stokd.cloud/store/',
  stokedUi: 'https://sui.stokd.cloud/'
};
