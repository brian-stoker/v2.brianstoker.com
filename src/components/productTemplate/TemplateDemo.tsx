...
import { DEMOS, icons, TEMPLATES } from 'src/components/productMaterial/MaterialTemplates';
      ...
      <Grid container spacing={2} alignItems="center">
        <Grid item md={6} sx={{ minWidth: 0 }}>
          ...
          <Group desktopColumns={2} sx={{ m: -2, p: 2 }}>
            ...
            <More
              component={Link}
              href="https://stoked-ui.com/store/?utm_source=marketing&utm_medium=referral&utm_campaign=templates-cta2#populars"
              noLinkStyle
            />
          </Group>
        </Grid>
