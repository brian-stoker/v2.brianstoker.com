...
const rowHeaders: Record<string, React.ReactNode> = {
  ...
  'data-grid/grouping': (
    <ColumnHead label="Row grouping" href="https://stoked-ui.com/x/react-data-grid/row-grouping/" />
  ),
    ...
    <Button
      ...
      href={
        licensingModel === 'annual'
          ? 'https://stoked-ui.com/store/items/mui-x-pro/'
          : 'https://stoked-ui.com/store/items/mui-x-pro-perpetual/'
      }
      variant="contained"
...
function PricingTableBuyPremium() {
  ...
  return (
    <Button
      ...
      href={
        licensingModel === 'annual'
          ? 'https://stoked-ui.com/store/items/mui-x-premium/'
          : 'https://stoked-ui.com/store/items/mui-x-premium-perpetual/'
      }
      variant="contained"
      fullWidth
      endIcon={<KeyboardArrowRightRounded />}
