...
import Item, { Group } from 'src/components/action/Item';
import Highlighter from 'src/components/action/Highlighter';
import Frame from 'src/components/action/Frame';
import { Link } from '@stoked-ui/docs/Link';
import More from 'src/components/action/More';
  ...
  [DEMOS[0]]: [
    {
      ...
      href: 'https://stoked-ui.github.io/store/items/devias-kit-pro/',
    },
    {
      ...
      href: 'https://stoked-ui.github.io/store/items/minimal-dashboard/',
    },
    {
      ...
      href: 'https://stoked-ui.github.io/store/items/berry-react-material-admin/',
    },
    {
      ...
      href: 'https://stoked-ui.github.io/store/items/mira-pro-react-material-admin-dashboard/',
    },
  ],
  [DEMOS[1]]: [
    {
      ...
      href: 'https://stoked-ui.github.io/store/items/the-front-landing-page/',
    },
    {
      ...
      href: 'https://stoked-ui.github.io/store/items/webbee-landing-page/',
    },
  ],
  [DEMOS[2]]: [
    {
      ...
      href: 'https://stoked-ui.github.io/store/items/bazar-pro-react-ecommerce-template/',
    },
  ],
};
  ...
  return (
    <Section bg="gradient" cozy>
      ...
      <Group rowLayout desktopColumns={2} sx={{ p: 2 }}>
        ...
        <More
          component={Link}
          href="https://stoked-ui.github.io/store/?utm_source=marketing&utm_medium=referral&utm_campaign=material-templates-cta2#populars"
          noLinkStyle
        />
      </Group>
      <Frame sx={{ mt: 3 }}>
