  ...
  [DEMOS[0]]: [
    {
      ...
      href: 'https://stoked-ui.com/store/items/devias-kit-pro/',
    },
    {
      ...
      href: 'https://stoked-ui.com/store/items/minimal-dashboard/',
    },
    {
      ...
      href: 'https://stoked-ui.com/store/items/berry-react-material-admin/',
    },
    {
      ...
      href: 'https://stoked-ui.com/store/items/mira-pro-react-material-admin-dashboard/',
    },
  ],
  [DEMOS[1]]: [
    {
      ...
      href: 'https://stoked-ui.com/store/items/the-front-landing-page/',
    },
    {
      ...
      href: 'https://stoked-ui.com/store/items/webbee-landing-page/',
    },
  ],
  [DEMOS[2]]: [
    {
      ...
      href: 'https://stoked-ui.com/store/items/bazar-pro-react-ecommerce-template/',
    },
  ],
};
  ...
  return (
    <Section bg="gradient" cozy>
      ...
      <Group rowLayout desktopColumns={2} sx={{ p: 2 }}>
        ...
        <More
          component={Link}
          href="https://stoked-ui.com/store/?utm_source=marketing&utm_medium=referral&utm_campaign=material-templates-cta2#populars"
          noLinkStyle
        />
      </Group>
      <Frame sx={{ mt: 3 }}>
