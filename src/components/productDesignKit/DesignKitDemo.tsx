    ...
    <Frame.Info data-mui-color-scheme="dark">
      ...
      <Box sx={{ display: 'flex', flexDirection: { xs: 'column', sm: 'row' }, gap: 1.5 }}>
        <Button
          ...
          size="small"
          noLinkStyle
          href="https://stoked-ui.com/store/?utm_source=marketing&utm_medium=referral&utm_campaign=design-cta2#design"
      ...
      <Grid container spacing={2} alignItems="center">
        <Grid md={6} sx={{ minWidth: 0 }}>
          ...
          <Group desktopColumns={2} sx={{ m: -2, p: 2 }}>
            ...
            <More
              component={Link}
              href="https://stoked-ui.com/store/?utm_source=marketing&utm_medium=referral&utm_campaign=design-cta3#design"
              noLinkStyle
            />
          </Group>
        </Grid>
