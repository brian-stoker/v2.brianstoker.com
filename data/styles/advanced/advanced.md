...
A frequent source of confusion is TypeScript's [type widening](https://mariusschulz.com/plan/literal-type-widening-in-typescript), which causes this example not to work as expected:
